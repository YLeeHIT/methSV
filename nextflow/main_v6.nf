...
// Parameters
// --------------------
params.input_vcf       = "sam1.cuteSV_force_calling.genotype.vcf.gz"
params.sample_id       = "sam1"
params.threads         = 4
params.methylation_bed = "sam1_meth.bed"
params.genome_file     = "genome.pos"
params.input_bam       = "sam1_chr22.bam"
